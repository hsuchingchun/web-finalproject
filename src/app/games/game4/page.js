...
const veggieImg =
  "https://i.postimg.cc/g29yLBWc/Chat-GPT-Image-2025-4-7-07-13-47.png";
    ...
    <div className="game-bg-wrapper">
      ...
      <div className="game-wrapper">
        ...
        <div id="gameContainer" ref={gameRef}>
          <div id="timer" className="pixel">
            TIME:{timeLeft}
          </div>
          <div id="score" className="pixel">
            SCORE:{score}
          </div>
          ...
          {effects.map((effect) => (
            <div
              key={effect.id}
              className={`effect ${
                effect.text.startsWith("+") ? "plus" : "minus"
              }`}
          ...
          {showIntro && (
            <div id="introOverlay">
              ...
              <p className="intro-detail">
                肉腸披薩🍕+5 ，青花菜披薩🥦 -3 ，肉腸披薩掉地上💥 -5
              </p>
              <p className="intro-detail">
                ❗70 分以上才能讓研究生滿足、回去寫論文❗
              </p>
              <button
          ...
          {gameOver && (
            <div id="resultScreen">
              <h3 className="result-title">
                {score >= 70 ? "✨ SUCCESS ✨" : "💣 FAIL 💣"}
              </h3>
              <h3>
                <span className="result-num">{score}</span> 分！吃了{" "}
                <span className="result-num">{meatCount}</span> 片肉腸披薩！
              </h3>
              <p>
                {score >= 70
                  ? "大滿足！回去寫論文！😇 ❤️"
